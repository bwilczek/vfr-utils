...
module VfrUtils
  module CLI
    ...
    def self.usage
      ...
      STDERR.puts "  notam <space delimited list of ICAO codes>"
      # STDERR.puts "  metar <space delimited list of ICAO codes>"
      # STDERR.puts "  taf <space delimited list of ICAO codes>"
      STDERR.puts ""
      1
    end
    ...
    def self.notam(icao_codes)
      ...
      require_relative 'notam/formatter'
      VfrUtils::NOTAM::Formatter.pretty_display(VfrUtils::NOTAM.get(icao_codes))
    end
